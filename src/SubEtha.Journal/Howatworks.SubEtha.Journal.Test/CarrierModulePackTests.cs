...
{
    public class CarrierModulePackTests
    {
        ...
        public void Cost()
        {
            var cost = JsonConvert.DeserializeObject<CarrierModulePack>(CostSample);
        ...
        public void Refund()
        {
            var refund = JsonConvert.DeserializeObject<CarrierModulePack>(RefundSample);
