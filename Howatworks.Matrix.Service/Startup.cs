...
using Howatworks.Matrix.Service.Persistence;
...
namespace Howatworks.Matrix.Service
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IGroupRepository groupRepoz, IConfiguration config)
        {
            ...
            var section = config.GetSection("Howatworks.Matrix.Service");
            var url = section["ServiceBinding"] ?? "http://+:8984/Matrix/Service";
